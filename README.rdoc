...
Part 2 creating a project in Rails - Buzzboard
 ...
 - In the command line write:
  - rails new buzzboard 
   - note the buzzboard in the name of the project, this could be anything
   - this creates a folder called buzzboard and many files
  - cd buzzboard
   - importand to move into the right folder for this
...
Part 3 adding "topics" to Buzzboard
 ...
 - Rails can generate the code, files and database for this using these commands on the command line:
